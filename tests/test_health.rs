...
// Note: Integration tests for health::run() are covered by CLI tests
// and individual health check functions are tested separately below.
// Removed problematic directory-changing tests that caused CI instability.
